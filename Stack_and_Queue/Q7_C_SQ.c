...
int balanced(char *expression)
{
	// balanced -> 참이면1, 거짓이면 0 리턴
	//  pop조건 : 스택 Top의 닫는 괄호가 자기의 pair 일때
	...
	if (isEmptyStack(s)) // 스택이 비어있으면 Balanced
		return 1;
	else
		return 0; // 스택에 문자가 남아있으면 Unbalanced
}
